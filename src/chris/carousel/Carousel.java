package chris.carousel;

import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;

import chris.librariansep.R;
...
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
	...
	/*Additional method to force carousel to render correctly on start CB 20140802*/
	private boolean firstCreate = true;
	private void firstLayoutCreate() {
		if (firstCreate) {
			this.setSelection(mSelectedPosition);
			firstCreate = false;
		}
	}
